...
namespace E_ticaret_sitesi.Controllers
{
    public class UrunController : Controller
    {
        ...
        {
            //LINQ (Language-Integrated Query) kullanarak bir veritabanından veri çekme işlemini gerçekleştirir. 
            //Kodun amacı, "c" adlı bir veritabanındaki "Kategoris" adlı tablodan veri alarak bir SelectListItem listesi oluşturmaktır.
